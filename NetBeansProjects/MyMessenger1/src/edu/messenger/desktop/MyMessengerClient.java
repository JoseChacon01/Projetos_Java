...
public class MyMessengerClient extends javax.swing.JFrame {
    ...
    public void conectarAoServidor(String ipCnn, String nickName) {
        ...
        erro1 = comMyMessegerClient.conectar();
    ...
    private void btEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEnviarActionPerformed
        ...
        taMensagem.setText("");
        if (error != 0){
            JOptionPane.showMessageDialog(this, "Erro ao tentar se conectar ao servidor.");
        }
    }//GEN-LAST:event_btEnviarActionPerformed

    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed

        ipCnn = JOptionPane.showInputDialog(this, "Digite o IP da conexão");
